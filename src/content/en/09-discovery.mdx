...
**What does success look like?** "Faster" and "smarter" are not answers, they are moods. A real answer names a number and a direction: tickets resolved per agent per day, first-response time, a percentage reduction in a specific queue.
...
<Callout kind="mistake" title="The recurring lesson">
  An answer without a number, an owner and a date is not a requirement. It is an aspiration, and it belongs in a vision slide, not a scope document.
</Callout>
