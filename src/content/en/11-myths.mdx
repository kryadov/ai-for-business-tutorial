...
The final exam mixes all eleven sections together, with no label telling you which chapter a question came from. That is the honest version of the test, because a real meeting never announces which chapter it is about to check.
