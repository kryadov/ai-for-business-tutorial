...
Four words do most of the damage in AI conversations: assistant, <T id="rag" locale="en">RAG</T>, <T id="text2sql" locale="en">text2SQL</T>, <T id="agent" locale="en">agent</T>. They get used as synonyms, as fashions, and as reassurance. They are none of those. They are four different answers to four different questions, with different costs, different data requirements and different ways of failing.
