...
Chapter 5 gave you four questions and four classes. This chapter turns them into a tree you can run silently while a client is still talking, and adds the class that question set left out: the case where the steps never change at all. Five classes, not four, and a tree that ends every branch in one of them before you have said a word back.
