...
**Revenue growth** shows up as "we want to close more deals" or "we're losing leads somewhere in the funnel." It stops being aspirational the moment someone can point to a conversion rate today, before anything changes — no baseline, no way to prove the project worked.
